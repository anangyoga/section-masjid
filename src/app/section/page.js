  ...
  return (
    <>
      ...
      <section className="relative">
        <div className="bg-gradient-to-b from-black/50 to-transparent h-[40rem] w-full absolute top-0 -z-20"></div>
        <img src="/tiang.webp" alt="tiang raksasa" className="absolute w-full h-auto top-0 -z-30 opacity-20" />
        <div className="mx-auto max-w-[65ch] py-8 flex flex-col gap-6 px-4">
          <motion.p initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
